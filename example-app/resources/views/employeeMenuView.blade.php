...
<body style="background-color: #F9F5EB;">
    <div class="container">
        <h1 style="text-align: right; color:#1C3879; font-style:Sans-serif;">FOOD sayani ITEMS</h1>
        <button class="menuAddBtn" onclick="location='/empAddMenu'"><b>Add sayas New Item</b></button>
        <hr /><br /><br />
        <div class="row">
            ...
            <div class="column">
                <div class="card">
                    ...
                    <a href = "/updateEmpFood/{{$data->id}}" class = "menuEditBtn fa fa-edit"> Edit </a>
