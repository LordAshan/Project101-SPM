...
<body style="background-color: #F9F5EB;">
    <div class="container">
        ...
        <p id="demo" style="text-align: right; color:#1C3879; font-style:Sans-serif;"></p>

     
        <button class = "menuAddBtn" onclick="location='/adminAddMenu'"> <b>Add New Item</b></button>
        <hr /><br /><br />
        <div class="row">
            ...
            <div class="column">
                ...
                <a href = "/updateFood/{{$data->id}}" class = "menuEditBtn fa fa-edit"> Edit </a>

                    <a onclick="myFunction()" href = "/deleteMenu/{{$data->id}}" class = "menuDeleteBtn fa fa-trash"> <b> Delete</b> </a>
    ...
    <script>
           function myFunction() {
            ...
            if (alert("Do u want to delete") == true) {
                text = "Deleted successfully";
            } else {
                text = "Deleted successfully";
            }
          
            setTimeout((document.getElementById("demo").innerHTML = text),5000000);
            }
