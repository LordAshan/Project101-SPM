...
<body style="background-color: #E9EADE;">
    ...
    <div class="container" style="background-color: #E9EADE;">
        <h1 style="text-align: right; color:#1C3879; font-style:Sans-serif;">Update FOOD ITEMS</h1>
        <hr /><br /><br />
        <div class="card-body">
        ...
        <form method = "post" action = "/updateEmpFood">
    ...
    @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-75">
                    <input type="text" value="{{$data->foodName}}" name="foodName" >
                ...
                <div class="row">
                    ...
                    <div class="col-75">
                    <input type="text" value="{{$data->ingredients}}" name="ingredients" >
